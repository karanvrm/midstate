...
export default async function StaffDashboardPage({ searchParams }: PageProps) {
  ...
  if (!isStaff && !(isOwner && isExplicitlyAllowed)) {
    redirect("/dashboard");
  }

  // Fetch full details from database to display complete info
        ...
        <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-sm md:text-base text-muted-foreground max-w-2xl leading-relaxed">
              {isOwner && isExplicitlyAllowed 
                ? "You are currently viewing the Staff Workspace as an Owner (Explicitly Allowed)."
                : "You have active access to the Midstate Global Services coordination dashboard. View profiles, manage features, and review candidates below."
              }
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Your staff credentials have been approved by the platform Owner. You have full access to internal pipelines.
              </p>
            </div>
          </div>
