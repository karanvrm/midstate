...
import StaffApplicationsClient from "@/components/dashboard/staff-applications-client";

const StaffApplicationsPage = async () => {
  ...
  if (session.user.role !== "STAFF" || session.user.status !== "ACTIVE") {
    redirect("/dashboard");
  }
        ...
        <div className="space-y-4">
          ...
          <div className="max-w-3xl space-y-3">
            ...
            <p className="text-base leading-7 text-muted-foreground">
              View and manage the job applications assigned to you. Access candidate resumes and review their details below.
            </p>
          </div>
        </div>
